...
ser = serial.Serial('/dev/ttyACM0', 115200) # Setup serial connection object at a specified port and baudrate
# Syncing with the MCU should be done ONLY when the Arduino Viewport is closed. Not sure why it doesnt work?
ser.write(b'Hello serial world!') # Send a binary encoded word to the port, this is done symbol by symbol
