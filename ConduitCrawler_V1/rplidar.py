...
class RPLidar(object):
    ...
    def iter_measurments(self, max_buf_meas=1000): # buf_meas was 500 making 1000
    ...
    def iter_scans(self, max_buf_meas=1000, min_len=5): # buf_meas was 500 now 1000
